...
country = {
	...
	GREATNESS_DAYS = 730, 	   -- how many days until country risks losing status as great nation
	BADBOY_LIMIT = 100,
	MAX_BUREAUCRACY_PERCENTAGE = 0.004, -- More than max percent bureaucrats of poplation will give no additional benefits
	...
	MOBILIZATION_SPEED_RAILS_MULT = 1.8, -- Speed modifier for raising troops. It's max value for max railways level in state.
	COLONIZATION_INTEREST_LEAD = 3,
	COLONIZATION_INFLUENCE_LEAD = 3,
	COLONIZATION_MONTHS_TO_COLONIZE = 10,
...
economy = {
	...
	GOODS_FOCUS_SWAP_CHANCE = 0.2, -- Percent increased chance that artisan wants to change goods independantly of how well he is doing presently
	...
	BANKRUPCY_DURATION = 4, -- Years til a bancrupcy clears all loans
	...
	FACTORY_PURCHASE_MIN_FACTOR = 0.3,			-- the lowest % of its daily needs a factory will purchase
...
military = {
	...
	AI_TRANSPORT_PROPORTION = 0.8, -- fraction of ships in the navy that should be should be transports
	...
	AI_ESCORT_RATIO = 0.2, -- ratio of escorts to transports in invasion fleets
...
diplomacy = {
	...
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.40, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
...
ai =
{
	...
	ADMINISTRATOR_WEIGHT = 95.0, -- ai weight for new bureaucrat
	INDUSTRYWORKER_WEIGHT = 15.0, -- ai weight for new industry workers
	EDUCATOR_WEIGHT = 70.0, -- ai weigth for new clergy
	...
	CHANCE_BUILD_FORT = 0.8,
	CHANCE_INVEST_POP_PROJ = 0.8,
	CHANCE_FOREIGN_INVEST = 0.64,
